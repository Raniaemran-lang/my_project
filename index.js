        ...
        if( this.phase === 'firework' ){
                ...
                if( !this.spawned ){
                        ...
                        if( this.tick >= this.reachTime ){
                                ...
                                this.circleFinalSize =  Math.random();
                ...
                if( this.circleCreating ){
                        ...
                        var proportion = this.tick2 / this.circleCompleteTime,
                                        armonic = -Math.cos( proportion * Math.PI ) / 2 +.8;

                        ctx.beginPath();
                        ctx.fillStyle = this.lightAlphaColor.replace( 'light', 30 + 70 * proportion ).replace( 'alp', proportion );
                        ctx.beginPath();
                ...
                if( this.spawning ){
                        ...
                        ++this.tick;
                        ctx.fillStyle = this.lightColor.replace( 'dark', 70 );
                        ctx.fillText( this.char, this.x + this.dx, this.y + this.dy );
...
function generateBalloonPath( x, y, size ){
        ...
        ctx.moveTo( x, y );
        ctx.bezierCurveTo( x - size / 5, y - size / 3,
                                                                                  x - size / 2, y - size,
                                                                           x,            y - size );
